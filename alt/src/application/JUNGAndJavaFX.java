...
>>>>>>> Stashed changes:src/application/JUNGAndJavaFX.java
...
public class JUNGAndJavaFX extends Application {
	...
	public void start(Stage stage) {
		...
		root.getFXRenderer().setEdgeRenderer(
				new FXEdgeRenderer<String, Integer>() {
					public void paintEdge(IFXRenderContext<String, Integer> rc,
						...
						Line l = new Line(start.getX(), start.getY(), end
								.getX(), end.getY());
						l.startXProperty().bind(graph);
